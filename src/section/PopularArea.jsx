...
function PopularArea () {
  ...
  return (
   ...
   <div>
    <h1 data-aos='zoom-in' className='text-red-500 light:text-black'>POPULAR AREAS</h1>
    <h1 data-aos='zoom-in' className='text-black text-[40px] font-semibold leading-10 mt-4 light:text-black'>Explore most <br /> Popular Areas </h1>
   </div>
