...
function Properties() {
  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      <section
        id="propertyies"
        className="lg-w[90%] w-full m-auto py-20 px:6 lg:px-20 flex flex-col justify-center items-start gap-10"
      >
        ...
        <div
          id="grid-box"
          className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full justify-center items-center"
        >
